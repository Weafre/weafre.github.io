...
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">how does decoder know the end of sequence: specific in metadata or use a special flag in sequence </li>  
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">fixed point coding: instead of using floating point --> use 16 bit, range from 0 to 65535 --> interger number represent sequence. problem: the precision will be limit, there may be a range when can not futher split (s.t.[182-184])  </li>
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">slove by scaling:  
	<ul>
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">E1: if current range is in the first half (0-32767), output 0 and scale back to full range (0-65535)  </li>
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">E2: if current range is in the second half (32767-65535), output 1 and scale back to full range (0-65535)  </li>
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">E3: If our low value is greater than one quarter of our range (16,383), and our high value is less than  
...
<ul>
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">	If e1 scaling, output a 0 and then n 1's, where n equals the e3 counter.  </li>
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">	If e2 scaling, output a 1 and then n 0's, where n equals the e3 counter. </li>
</ul>
	</ul> </li>
...
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">BINARY ARITHMETIC CODING</li>
...
<li style="list-style-type:lower-alpha;font-size:100%;color:black;">While a context is active, it's probabilities are updated in the same manner as our adaptive binary
coder</li>
